                ...
                <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950">
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="flex flex-col items-center space-y-4 text-center">
                            ...
                            {/* Demo Access Card */}
                            <div className="mt-8 p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg max-w-lg">
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between gap-4 border-b border-gray-100 dark:border-gray-700 pb-2">
                                        ...
                                        <div className="text-right">
                                            <p className="text-sm font-medium text-gray-900 dark:text-white">Member Login</p>
                                            <p className="text-xs text-gray-500 dark:text-gray-400 font-mono mt-1">
                                                +919876543210 / 123456
                                            </p>
                                        </div>
                                    ...
                                    <p className="text-[10px] text-gray-400 text-center">
                                        Note: OTP 123456 works only for the above demo number.
                                    </p>
                                </div>
                            </div>
